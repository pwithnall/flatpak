...
port=$(cat httpd-port)
${FLATPAK} ${U} remote-add --gpg-import=${FL_GPG_HOMEDIR}/pubring.gpg $REPONAME-repo "http://127.0.0.1:${port}/${REPONAME}" >&2
ORIGINAL_SUBKEY_FINGERPRINT="$(${GPG} --homedir "${FL_GPG_HOMEDIR}" --list-keys --fingerprint | grep fpr | head -1 | cut -d : -f 10)"
...
echo -e "uid 1\nkey 2\nrevkey\ny\n0\nTest subkey revocation\n\ny\nsave\n" | ${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --command-fd 0 --edit-key "${NEW_SUBKEY_FINGERPRINT}" >&2
...
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT}" --quick-sign-key "${ORIGINAL_KEY_FINGERPRINT}" >&2
...
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --quick-gen-key "New primary 1" default sign >&2
NEW_KEY_FINGERPRINT1="$(${GPG} --homedir "${FL_GPG_HOMEDIR}" --list-keys --fingerprint | grep fpr | tail -1 | cut -d : -f 10)"
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --quick-gen-key "New primary 2" default sign >&2
NEW_KEY_FINGERPRINT2="$(${GPG} --homedir "${FL_GPG_HOMEDIR}" --list-keys --fingerprint | grep fpr | tail -1 | cut -d : -f 10)"
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --quick-gen-key "New primary 3" default sign >&2
NEW_KEY_FINGERPRINT3="$(${GPG} --homedir "${FL_GPG_HOMEDIR}" --list-keys --fingerprint | grep fpr | tail -1 | cut -d : -f 10)"

${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT1}" --quick-sign-key "${ORIGINAL_KEY_FINGERPRINT}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT2}" --quick-sign-key "${ORIGINAL_KEY_FINGERPRINT}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT3}" --quick-sign-key "${ORIGINAL_KEY_FINGERPRINT}" >&2

${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT1}" --quick-sign-key "${NEW_KEY_FINGERPRINT2}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT1}" --quick-sign-key "${NEW_KEY_FINGERPRINT3}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT2}" --quick-sign-key "${NEW_KEY_FINGERPRINT1}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT2}" --quick-sign-key "${NEW_KEY_FINGERPRINT3}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT3}" --quick-sign-key "${NEW_KEY_FINGERPRINT1}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT3}" --quick-sign-key "${NEW_KEY_FINGERPRINT2}" >&2
...
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${ORIGINAL_KEY_FINGERPRINT}" --quick-sign-key "${NEW_KEY_FINGERPRINT1}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT1}" --quick-sign-key "${NEW_KEY_FINGERPRINT2}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT2}" --quick-sign-key "${NEW_KEY_FINGERPRINT3}" >&2
...
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --faked-system-time 20260531T000000 --quick-gen-key "New primary" default sign >&2
NEW_KEY_FINGERPRINT="$(${GPG} --homedir "${FL_GPG_HOMEDIR}" --list-keys --fingerprint | grep fpr | tail -1 | cut -d : -f 10)"
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --faked-system-time 20260531T000001 --default-cert-expire 2026-06-01 --local-user "${NEW_KEY_FINGERPRINT}" --quick-sign-key "${ORIGINAL_KEY_FINGERPRINT}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --faked-system-time 20260531T000001 --default-cert-expire 2026-06-01 --local-user "${ORIGINAL_KEY_FINGERPRINT}" --quick-sign-key "${NEW_KEY_FINGERPRINT}" >&2
...
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${NEW_KEY_FINGERPRINT}" --quick-sign-key "${ORIGINAL_KEY_FINGERPRINT}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --local-user "${ORIGINAL_KEY_FINGERPRINT}" --quick-sign-key "${NEW_KEY_FINGERPRINT}" >&2
${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --quick-add-uid "${NEW_KEY_FINGERPRINT}" "New primary 2"
...
for ((i=0; i <= MAX_N_KEYS_TO_PROCESS; i++)); do
    ${GPG} --homedir "${FL_GPG_HOMEDIR}" --passphrase "" --quick-gen-key "New primary ${i}" default sign >&2
    NEW_KEY_FINGERPRINT="$(${GPG} --homedir "${FL_GPG_HOMEDIR}" --list-keys --fingerprint | grep fpr | tail -1 | cut -d : -f 10)"
